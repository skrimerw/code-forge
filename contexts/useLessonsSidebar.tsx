...
export function LessonsSidebarProvider({
    courseId,
    modules,
    children,
}: {
            ...
            <Sheet open={open}>
                ...
                >
                    ...
                    <Sidebar
                        modules={modules}
                        courseId={courseId}
                        className="mr-auto w-[250px] ml-0 border-0 p-4"
                    />
                </SheetContent>
            </Sheet>
            {children}
...
export function useLessonsSidebar() {
    const ctx = useContext(SidebarContext);

    if (!ctx) {
        throw new Error(
            "useLessonsSidebar must be used within LessonsSidebarProvider",
        );
    }
